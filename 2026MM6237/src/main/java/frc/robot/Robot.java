...
public class Robot extends TimedRobot {
  ...
  public void disabledPeriodic() {
    // Poll trim calibration buttons while disabled (robot is placed on field for calibration)
    CalibrateTrimCommand.pollDashboardTrigger(
        m_robotContainer.getLimelight(), m_robotContainer.getDrivetrain());
    CalibrateTrimCommand.pollApplyTrigger();
  }
  ...
  public void teleopPeriodic() {
    // Poll trim calibration buttons (also works during teleop for practice field tuning)
    CalibrateTrimCommand.pollDashboardTrigger(
        m_robotContainer.getLimelight(), m_robotContainer.getDrivetrain());
    CalibrateTrimCommand.pollApplyTrigger();
  }
