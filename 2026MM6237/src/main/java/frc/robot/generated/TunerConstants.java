...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(Constants.CommandSwerveDrivetrain.kSteerMotorKP)
        .withKI(Constants.CommandSwerveDrivetrain.kSteerMotorKI)
        .withKD(Constants.CommandSwerveDrivetrain.kSteerMotorKD)
        .withKS(Constants.CommandSwerveDrivetrain.kSteerMotorKS)
        .withKV(Constants.CommandSwerveDrivetrain.kSteerMotorKV)
        .withKA(Constants.CommandSwerveDrivetrain.kSteerMotorKA)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(Constants.CommandSwerveDrivetrain.kDriveMotorKP)
        .withKI(Constants.CommandSwerveDrivetrain.kDriveMotorKI)
        .withKD(Constants.CommandSwerveDrivetrain.kDriveMotorKD)
        .withKS(Constants.CommandSwerveDrivetrain.kDriveMotorKS)
        .withKV(Constants.CommandSwerveDrivetrain.kDriveMotorKV);
    ...
    private static final Current kSlipCurrent = Amps.of(Constants.CommandSwerveDrivetrain.kSlipCurrentAmps);
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = Constants.CommandSwerveDrivetrain.kSpeedAt12Volts;

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    private static final double kCoupleRatio = Constants.CommandSwerveDrivetrain.kCoupleRatio;

    private static final double kDriveGearRatio = Constants.CommandSwerveDrivetrain.kDriveGearRatio;
    private static final double kSteerGearRatio = Constants.CommandSwerveDrivetrain.kSteerGearRatio;
    private static final Distance kWheelRadius = Inches.of(Constants.CommandSwerveDrivetrain.kWheelRadiusInches);

    private static final boolean kInvertLeftSide = Constants.CommandSwerveDrivetrain.kInvertLeftSide;
    private static final boolean kInvertRightSide = Constants.CommandSwerveDrivetrain.kInvertRightSide;

    private static final int kPigeonId = Ports.kPigeon2Id;

    // These are only used for simulation
    private static final MomentOfInertia kSteerInertia = KilogramSquareMeters.of(Constants.CommandSwerveDrivetrain.kSteerInertiaKgm2);
    private static final MomentOfInertia kDriveInertia = KilogramSquareMeters.of(Constants.CommandSwerveDrivetrain.kDriveInertiaKgm2);
    // Simulated voltage necessary to overcome friction
    private static final Voltage kSteerFrictionVoltage = Volts.of(Constants.CommandSwerveDrivetrain.kSteerFrictionVoltage);
    private static final Voltage kDriveFrictionVoltage = Volts.of(Constants.CommandSwerveDrivetrain.kDriveFrictionVoltage);
    ...
    // Front Left
    private static final int kFrontLeftDriveMotorId = Ports.kFrontLeftDriveMotor;
    ...
    // Front Right
    private static final int kFrontRightDriveMotorId = Ports.kFrontRightDriveMotor;
    ...
    // Back Left
    private static final int kBackLeftDriveMotorId = Ports.kBackLeftDriveMotor;
    ...
    // Back Right
    private static final int kBackRightDriveMotorId = Ports.kBackRightDriveMotor;
